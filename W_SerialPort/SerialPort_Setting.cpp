...
SerialPort_Setting::SerialPort_Setting()
{
...
bool SerialPort_Setting::openPort(const char* portname, int baudrate, char parity,
...
void SerialPort_Setting::closePort()
{
	HANDLE hCom = *(HANDLE*)pHandle;
	CloseHandle(hCom);
}

int SerialPort_Setting::sendData(const void *buf, int len)
{
	HANDLE hCom = *(HANDLE*)pHandle;
	if (this->synchronizeflag)
	{
...
int SerialPort_Setting::receiveData(void *buf, int maxlen)
{
	HANDLE hCom = *(HANDLE*)pHandle;
